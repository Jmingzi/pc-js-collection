...
var YmDrag = function () {
    function YmDrag(params) {
        _classCallCheck(this, YmDrag);
    ...
    _createClass(YmDrag, [{
        key: '_getBoxOffset',
        value: function _getBoxOffset(box) {
            return {
        ...
        key: '_isInBox',
        value: function _isInBox(type, pageX, pageY) {
            var box = null,
                block = [],
                that = this;

            if (type === "block") {
                var dragged = this.opts.dragToBox.find(".block.dragged");
                // console.log("区块数量：" + dragged.length)

                for (var i = 0; i < dragged.length; i++) {
                    box = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(dragged[i]);

                    var _that$_getBoxOffset = that._getBoxOffset(box),
                        _boxLeft = _that$_getBoxOffset.boxLeft,
                        _boxRight = _that$_getBoxOffset.boxRight,
                        _boxTop = _that$_getBoxOffset.boxTop,
                        _boxBottom = _that$_getBoxOffset.boxBottom;

                    if (pageX >= _boxLeft && pageX < _boxRight && pageY >= _boxTop && pageY < _boxBottom) {
                        return box;
                    }
                }
            ...
            var _that$_getBoxOffset2 = that._getBoxOffset(box),
                boxLeft = _that$_getBoxOffset2.boxLeft,
                boxRight = _that$_getBoxOffset2.boxRight,
                boxTop = _that$_getBoxOffset2.boxTop,
                boxBottom = _that$_getBoxOffset2.boxBottom;

            return pageX >= boxLeft && pageX < boxRight && pageY >= boxTop - 50 && pageY < boxBottom;
        }
    }, {
        key: '_addTargetMark',
        value: function _addTargetMark(pageY, blockElement) {
            var targetLine = this.body.find(".target-line"),
            ...
            if (targetLine.length !== 0) {
                ...
                targetLine = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div></div>').addClass("target-line").css('display', 'block');
            }
        ...
        key: '_computeMovePosition',
        value: function _computeMovePosition(pageY, blockElement) {
            var me = this,
                dragItems = null;
            ...
            dragItems.each(function (i) {
                ...
                if (itemLen === 1) {
                    ...
                    if (i < itemLen - 1) {
                        // 计算offsetTop + 自身高度的一半
                        var halfTop = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).offset().top - me.opts.dragToBox.offset().top + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).outerHeight(true) / 2;
        ...
        key: '_compareTop',
        value: function _compareTop(diffTop, itemTopArr) {
            var data = {
                index: 0,
                fx: 'before'
            };
            ...
            if (itemTopArr.length === 1 && diffTop - itemTopArr[0] > 0) {
                ...
                fall = itemTopArr.map(function (item) {
                    return diffTop - item;
                });
                // 先找到最小值
                min = fall[0];

                fall.forEach(function (item) {
                ...
                // 找到最小值的下标，以及符号
                data.index = fall.findIndex(function (item) {
                    return item === min;
                });
        ...
        value: function bindEvents() {
            ...
            this.opts.dragFromBox.on({
                ...
                mousedown: function mousedown(e) {
                    ...
                    if (e.button === 0) {
                        ...
                        dragCurrNode = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
                        ...
                        // 加上时间戳，唯一标识name
                        cloneDragNode.attr("data-component", cloneDragNode.attr('data-component') + "-" + new Date().getTime());
            ...
            this.opts.dragToBox.on({
                click: function click(e) {
                    ...
                    me._setCurrent(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this));
                },
                mousedown: function mousedown(e) {
                    e.stopPropagation();
                ...
                mouseover: function mouseover(e) {
                    ...
                    if (me.opts.delShowCondition && me.opts.delShowCondition(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this))) {
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.del-drag').css('display', 'block');
                    }
                },
                mouseout: function mouseout(e) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.del-drag').css('display', 'none');
                }
            }, '.mDrag-item');
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on({
                mousemove: function mousemove(e) {
                    ...
                    if (e.button === 0 && _move) {
                        ...
                        // 位置变化
                        cloneDragNode.css({ 'visibility': "visible", top: _moveY, left: _moveX }).removeClass("curr-edit").addClass("draging");
                            ...
                            if (!me._isInBox("to", _moveX, _moveY)) {
                                ...
                                if (blockElement) {
                                    ...
                                    if (cloneDragNode.hasClass("block")) {
                                        ...
                                        // 计算目标位置
                                        var data = me._computeMovePosition(_moveY, blockElement);
                                    ...
                                    if (temp.length > 1) {
                                        // 计算目标位置
                                        var _data = me._computeMovePosition(_moveY, blockElement);
                                        temp = temp.eq(_data.index);
                                        temp[_data.fx](cloneDragNode);
                                    } else {
                                        temp.before(cloneDragNode);
                                    }
                                }
...
/* harmony default export */ __webpack_exports__["a"] = (YmDrag);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mDrag__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mDrag_scss__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mDrag_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__mDrag_scss__);




new __WEBPACK_IMPORTED_MODULE_1__mDrag__["a" /* default */]({
    dragFromBox: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.mDrag-from'),
    dragToBox: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.mDrag-to'),
    delShowCondition: function delShowCondition(dragItem) {
        // console.log(dragItem)
        return true;
    },
    beforeDel: function beforeDel(dragItem) {
        console.log('beforeDel');
    },
    afterDel: function afterDel(dragItem) {
        console.log('afterDel');
    },
    beforeDrag: function beforeDrag(dragItem) {
        console.log('beforeDrag');
    },
    afterDrag: function afterDrag(dragItem) {
        // console.log(dragObj)
